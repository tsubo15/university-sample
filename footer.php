            ...
            <div class="footer_content">
                ...
                <div class="col-lg-3 footer_col">
                    ...
                    <div class="footer_links_container">
                        <ul>
                        <li><a href="<?php home_url(); ?>/category/news">ニュース</a></li>
                        <li><a href="<?php home_url(); ?>/category/events">イベント</a></li>
                        <li><a href="<?php home_url(); ?>/courses">コース</a></li>
                        <li><a href="<?php home_url(); ?>/about">侍大学について</a></li>
                        </ul>
                    </div>
                    </div>
                </div>
